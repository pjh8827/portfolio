...
public class FileUrlDownload {
 ...
 public static void main(String[] args) {
  ...
  // 파일 어드레스
  String url = "https://fresh.ihaccp.or.kr/prdimg/2003/2003048412038/2003048412038-2.jpg";
  // 다운로드 디렉토리
  String downDir = "./src/main/resources/static/img";

  // 다운로드 호출
  fileUrlDownload(url, "./src/main/resources/static/img");
