...
<body id="page-top">
    ...
    <!-- Main Contents -->
    <!-- Portfolio Section -->
    <section class="page-section portfolio" id="qnalist">
        <div class="container">

            <!-- Portfolio Section Heading -->
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Q&A
            </h2>
            ...
            <div class="d-left justify-content-center">
                ...
                <form action="/qna/search.do" v-on:submit.prevent="searchQna()">
                ...
                <c:if test="${!empty id}">
                    <div class="text-center">
                        <button class="btn btn-primary " id="addbtn" onclick="location.href='/qna/regist.do'">Q&A
                            등록</button>
                    </div>
                </c:if>
    ...
    <script>
        var qnalist = new Vue({
            ...
            mounted() {
                ...
                axios.get("/rest/Qna/Page?page=1&range=1")
                    .then(response => {

                        response = response.data.data;

                        this.qnalist = response.items;
                        this.qnalist.forEach(p => {
                            p["url"] = "/qna/detail.do?no=" + p.no;
                        });
            ...
            methods: {
                ...
                gotoPage(pagenum) {
                    ...
                    axios.get("/rest/Qna/Page?page=" + page + "&range=" + range)
                        .then(response => {
                ...
                searchQna() {
                    ...
                    let url = 'rest/qna/search?condition=' + c + '&key=' + k;
