...
function SearchList({ currentPage, totalPage, setCurrentPage, changePage, isCategoryAndListVisible, setIsCategoryAndListVisible, isListVisible, setIsListVisible, merchantList}: Props): ReactElement {
...
export default inject(({ merchant, window }) => ({
