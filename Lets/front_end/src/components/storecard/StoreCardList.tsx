...
import { BlackButton } from 'components/storecard/StoreCard';
...
function StoreCardList({ merchants, refs, setRefs, clickedMerchant, setClickedMerchant, setCurrentLatLong, setMerchants,
  currentPage, totalPage, changePage, userLatLong, userLatLongActivated, isNoMerchants }: Props): ReactElement {
